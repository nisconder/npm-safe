...
<img src="docs/assets/dsh-install-risk-card.svg" alt="npm-safe visual DSH plugin installation risk card" width="100%">

<sub>Illustrative DSH plugin preflight. The desktop app analyzes and generates a pinned command; it does not install from this screen.</sub>
