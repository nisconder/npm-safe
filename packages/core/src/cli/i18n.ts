...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "gate.enableHint": "Hint: run `npm-safe gate shell` so npm/pnpm/yarn add go through the gate automatically.",
    "gate.shell.noConfig": "Could not detect a shell config file. Use --file <path>.",
  ...
  zh: {
    ...
    "gate.enableHint": "提示：运行 `npm-safe gate shell` 可让 npm/pnpm/yarn add 自动经过门禁。",
    "gate.shell.noConfig": "未能检测到 shell 配置文件。请使用 --file <path> 指定。",
