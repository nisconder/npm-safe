...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "gate.enableHint": "Restart your shell (or re-source the config) for the npm/pnpm/yarn wrappers to take effect.",
  ...
  zh: {
    ...
    "gate.enableHint": "请重启 shell（或重新加载配置）以使 npm/pnpm/yarn 包装生效。",
