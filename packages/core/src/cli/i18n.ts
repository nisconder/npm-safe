...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "gate.shell.machineInstalled": "Shim directory prepended to the system PATH: {path}. Reopen terminals to activate.",
  ...
  zh: {
    ...
    "gate.shell.machineInstalled": "shim 目录已加入系统 PATH 最前：{path}。请重新打开终端生效。",
